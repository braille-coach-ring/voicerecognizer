...
class TestVoiceActivityDetector(unittest.TestCase):
    ...
    def test_environment_noise(self) -> None:
    ...
    def test_spike_noise(self) -> None:
    ...
    def test_speech_signal(self) -> None:
    ...
    def test_requires_consecutive_chunks_before_speech(self) -> None:
    ...
    def test_ignores_single_peak_noise(self) -> None:
        cfg = PreprocessConfig(
    ...
    def test_accepts_when_active_ratio_is_enough(self) -> None:
        cfg = PreprocessConfig(
            vad_silence_threshold=0.005,
            vad_min_speech_chunks=1,
            vad_min_active_ratio=0.02,
